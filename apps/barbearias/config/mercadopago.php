...
/*
|--------------------------------------------------------------------------
| Credenciais do Mercado Pago - KADOSYS Barbearias
|--------------------------------------------------------------------------
|
| Mesma conta/credenciais ja usadas pelo KADOSYS Igrejas - so muda o
| valor/plano cobrado. Usadas pelo modulo de assinatura recorrente
| (Checkout Pro + Assinaturas/preapproval + Pix avulso, ver
| Barbearias\Core\MercadoPagoClient). Assim como em Igrejas, NAO existe
| valor padrao com credencial real: sao dados financeiros sensiveis e
| tem que vir de variavel de ambiente configurada no servidor (cPanel >
| MultiPHP INI Editor, ou equivalente) - se o subdominio de Barbearias
| nao herdar as mesmas variaveis de ambiente do Igrejas, configure de
| novo aqui (mesmos valores). Sem elas configuradas, o modulo de
| assinatura fica desativado (ver MercadoPagoClient::configurado()).
|
| Variaveis esperadas:
...
|                        https://barbearias.kadosys.com.br).
|
...
|       'public_key' => 'APP_USR-...',
|       'webhook_secret' => '...',
|       'app_url' => 'https://barbearias.kadosys.com.br',
|   ];
|
*/
