...
/*
|--------------------------------------------------------------------------
| Configuracao de E-mail - KADOSYS Barbearias
|--------------------------------------------------------------------------
|
| Usada pelo envio de e-mails transacionais (ver Barbearias\Core\Mailer):
...
return [
    'from_email' => $overrides['from_email'] ?? (getenv('MAIL_FROM_EMAIL') ?: 'barbearias@kadosys.com.br'),
    'from_name' => $overrides['from_name'] ?? (getenv('MAIL_FROM_NAME') ?: 'KADOSYS Barbearias'),
];
