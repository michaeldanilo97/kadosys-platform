 ...
 * /apps/barbearias sem alterar a estrutura de pastas do site institucional.
 */
final class Router
{
    ...
    public function dispatch(): void
    {
        ...
        // Remove o prefixo de base (ex.: /apps/barbearias) para comparar
        // com os padroes de rota, que sao sempre definidos de forma
        // relativa.
