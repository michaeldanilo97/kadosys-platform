...
final class View
{
     ...
     * compartilhada/navegadores tendem a manter em cache a versao antiga
     * do CSS/JS por bastante tempo, fazendo um ajuste ja enviado (git
     * push) parecer que "nao aplicou" no aparelho do usuario.
     */
