 ...
 * partir da chave Pix da propria barbearia - sem nenhuma chamada a
 * gateway de pagamento. O dinheiro cai direto na conta da barbearia; o
...
final class PixEstatico
{
    ...
    /**
     * @param string $chave Chave Pix da barbearia (CPF, CNPJ, e-mail, telefone ou chave aleatoria)
    ...
    private static function normalizarTexto(string $texto, int $tamanhoMaximo): string
    {
        ...
        return substr($limpo !== '' ? $limpo : 'BARBEARIA', 0, $tamanhoMaximo);
    }
