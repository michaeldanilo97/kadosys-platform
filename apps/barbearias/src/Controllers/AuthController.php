...
final class AuthController extends Controller
{
    ...
    public function showForgotPassword(): void
    {
        echo $this->view('auth.esqueci-senha', [
            'pageTitle' => 'KADOSYS Barbearias - Recuperar senha',
            'csrf' => Csrf::field(),
    ...
    public function sendForgotPassword(): void
    {
        ...
        if ($user !== null && $user->active) {
            ...
            Mailer::enviar($user->email, $user->name, 'Recuperação de senha - KADOSYS Barbearias', $corpo);
        }
    ...
    public function showResetPassword(string $token): void
    {
        ...
        echo $this->view('auth.redefinir-senha', [
            'pageTitle' => 'KADOSYS Barbearias - Redefinir senha',
            'csrf' => Csrf::field(),
            'token' => $token,
    ...
    public function resetPassword(string $token): void
    {
        ...
        User::updatePassword($user->id, $user->barbeariaId, $senha);
        User::invalidarPasswordResets($email);
    ...
    {
        $host = (string) ($this->request->server['HTTP_HOST'] ?? 'barbearias.kadosys.com.br');
