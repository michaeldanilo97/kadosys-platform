...
<title>Seu horário está chegando - <?= htmlspecialchars($barbeariaNome, ENT_QUOTES, 'UTF-8') ?></title>
</head>
...
Seu horário na <?= htmlspecialchars($barbeariaNome, ENT_QUOTES, 'UTF-8') ?> é daqui a pouco,
