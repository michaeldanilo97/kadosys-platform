...
/*
|--------------------------------------------------------------------------
| Front Controller - KADOSYS Barbearias
|--------------------------------------------------------------------------
|
...
if (is_file($vendorAutoload)) {
    ...
    spl_autoload_register(static function (string $class): void {
        $prefixes = [
            'Barbearias\\Core\\' => dirname(__DIR__) . '/src/Core/',
            'Barbearias\\Controllers\\' => dirname(__DIR__) . '/src/Controllers/',
            'Barbearias\\Models\\' => dirname(__DIR__) . '/src/Models/',
        ];
