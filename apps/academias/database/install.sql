...
-- Migration 003 (fichas_treino/ficha_exercicios/treino_execucoes) - ja
-- incluida aqui pra instalacoes novas partirem direto com o modulo de
-- ficha de treino.
...
-- Migration 004 (avaliacoes_fisicas) - ja incluida aqui pra
-- instalacoes novas partirem direto com o modulo de avaliacao fisica.
