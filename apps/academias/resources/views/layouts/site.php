 ...
 * @var array $config
 * @var Academia|null $academia Presente so nas paginas de uma academia especifica (agendamento publico) - ausente na landing/cadastro/login.
 */
...
<head>
    ...
    <meta name="description" content="Gestão completa para academias: check-in por QR Code, ficha de treino, avaliação física e alunos num só lugar.">
...
<header class="site-nav" data-site-nav>
    <div class="site-nav-inner">
        ...
        <?php else: ?>
            <span class="site-brand"><span class="text-gradient">KADOSYS</span> Academias</span>
        <?php endif; ?>
        <?php if ($siteInstitucional): ?>
    ...
    <?php if ($siteInstitucional): ?>
        <div class="site-footer-inner">
            <div class="site-footer-col site-footer-brand">
                <span class="site-brand"><span class="text-gradient">KADOSYS</span> Academias</span>
                <p>Gestão completa pra academia: check-in, ficha de treino, avaliação física e alunos num só painel.</p>
            </div>
