...
$itensMenu = [
    ...
    ['slug' => 'planos-matricula', 'href' => '/dashboard/planos-matricula', 'icone' => 'bi-box-seam-fill', 'label' => 'Planos de Matrícula'],
    ['slug' => 'financeiro', 'href' => '/dashboard/financeiro', 'icone' => 'bi-cash-coin', 'label' => 'Financeiro'],
        ...
        <header class="dash-topbar">
            ...
            <div class="topbar-dropdown dash-topbar-user" data-topbar-dropdown>
                ...
                <div class="topbar-dropdown-panel user-panel" data-dropdown-panel hidden>
                    ...
                    <a href="<?= $basePath ?>/dashboard/configuracoes" class="user-panel-item"><i class="bi bi-gear-fill"></i> Configurações</a>
