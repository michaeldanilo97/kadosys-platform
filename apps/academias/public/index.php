...
/*
|--------------------------------------------------------------------------
| Front Controller - KADOSYS Academias
|--------------------------------------------------------------------------
|
...
if (is_file($vendorAutoload)) {
    ...
    spl_autoload_register(static function (string $class): void {
        $prefixes = [
            'Academias\\Core\\' => dirname(__DIR__) . '/src/Core/',
            'Academias\\Controllers\\' => dirname(__DIR__) . '/src/Controllers/',
            'Academias\\Models\\' => dirname(__DIR__) . '/src/Models/',
        ];
