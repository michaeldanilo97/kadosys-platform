...
final class AuthController extends Controller
{
    public function showLogin(): void
    {
        echo $this->view('auth.login', [
            'pageTitle' => 'KADOSYS Academias - Entrar',
            'csrf' => Csrf::field(),
    ...
    public function login(): void
    {
        ...
        if (!$auth->attempt($email, $password)) {
            ...
            $mensagem = match (true) {
                ...
                !$usuario->active => 'Esse usuário está desativado. Fale com quem administra sua academia.',
    ...
    public function showForgotPassword(): void
    {
        echo $this->view('auth.esqueci-senha', [
            'pageTitle' => 'KADOSYS Academias - Recuperar senha',
            'csrf' => Csrf::field(),
    ...
    public function sendForgotPassword(): void
    {
        ...
        if ($user !== null && $user->active) {
            ...
            Mailer::enviar($user->email, $user->name, 'Recuperação de senha - KADOSYS Academias', $corpo);
        }
    ...
    public function showResetPassword(string $token): void
    {
        ...
        echo $this->view('auth.redefinir-senha', [
            'pageTitle' => 'KADOSYS Academias - Redefinir senha',
            'csrf' => Csrf::field(),
            'token' => $token,
    ...
    public function resetPassword(string $token): void
    {
        ...
        User::updatePassword($user->id, $user->academiaId, $senha);
        User::invalidarPasswordResets($email);
