 ...
 * credenciais em tempo de requisicao), o Academias usa um UNICO banco
 * compartilhado - entao esta classe e so um singleton PDO simples, sem
 * variantes de conexao. O isolamento entre academias acontece na
 * camada de query (WHERE academia_id = ...), nao na camada de conexao.
 */
