 ...
 * partir da chave Pix da propria academia - sem nenhuma chamada a
 * gateway de pagamento. O dinheiro cai direto na conta da academia; o
...
final class PixEstatico
{
    ...
    /**
     * @param string $chave Chave Pix da academia (CPF, CNPJ, e-mail, telefone ou chave aleatoria)
    ...
    private static function normalizarTexto(string $texto, int $tamanhoMaximo): string
    {
        ...
        return substr($limpo !== '' ? $limpo : 'ACADEMIA', 0, $tamanhoMaximo);
    }
