...
/**
 * Rotas do aplicativo "condominio".
 *
...
$router->get("/", function () {
    return "<h1>Aplicativo Condominio</h1><p>Infraestrutura pronta. Modulos de negocio ainda nao implementados nesta v1.</p>";
})->setName("condominio.home");
