...
/*
|--------------------------------------------------------------------------
| Configuracao geral - KADOSYS Food
|--------------------------------------------------------------------------
|
...
| em https://food.kadosys.com.br quanto em outros caminhos, sem precisar
| alterar codigo.
|
*/
...
// para obter o caminho base da aplicacao (ex: /apps/food).
$basePath = preg_replace('#/public$#', '', $scriptDir);
$basePath = $basePath === '/' ? '' : rtrim((string) $basePath, '/');

return [
    'app_name'    => 'KADOSYS Food',
    'env'         => getenv('APP_ENV') ?: 'production',
    'debug'       => filter_var(getenv('APP_DEBUG') ?: 'false', FILTER_VALIDATE_BOOLEAN),
    'base_path'   => $basePath,
    'timezone'    => 'America/Sao_Paulo',
    'session_name' => 'kadosys_food_session',
    'remember_cookie' => 'kadosys_food_remember',
