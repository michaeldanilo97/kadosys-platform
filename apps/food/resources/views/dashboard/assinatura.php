 ...
 * @var FaturaRestaurante|null $fatura
 */
$basePath = $config['base_path'] ?? '';
$trialVencido = $restaurante->metodoPagamento === 'trial'
    && $restaurante->trialExpiraEm !== null
...
<main class="dashboard-main">
    ...
    <p class="subtitle">
        <?= $trialVencido
            ? 'Assine o plano ' . htmlspecialchars(Plano::label($restaurante->plano), ENT_QUOTES, 'UTF-8') . ' pra continuar usando o KADOSYS Food. Seus dados continuam guardados com segurança.'
            : 'Confirme o pagamento do plano ' . htmlspecialchars(Plano::label($restaurante->plano), ENT_QUOTES, 'UTF-8') . ' pra liberar o acesso de novo.' ?>
    </p>
