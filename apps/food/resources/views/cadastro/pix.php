...
<script>
    (function () {
        ...
        function verificar() {
            fetch(basePath + '/cadastro/pix/' + faturaId + '/status')
                ...
                .then(function (dados) {
                    ...
                    if (dados.status === 'expirada' || dados.status === 'cancelada') {
                        statusEl.textContent = 'Essa cobrança expirou. Volte e tente novamente.';
