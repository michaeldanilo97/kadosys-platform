 ...
 * credenciais em tempo de requisicao), o Food usa um UNICO banco
 * compartilhado - entao esta classe e so um singleton PDO simples, sem
 * variantes de conexao. O isolamento entre restaurantes acontece na
 * camada de query (WHERE restaurante_id = ...), nao na camada de conexao.
 */
