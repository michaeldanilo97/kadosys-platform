...
$router->get("/", function () {
    return "<h1>Aplicativo Streamer</h1><p>Infraestrutura pronta. Modulos de negocio ainda nao implementados nesta v1.</p>";
})->setName("streamer.home");
