...
final class RecursoController extends Controller
{
    ...
    public const MODULOS = [
        ...
        'projecao' => [
            ...
            'imagem' => 'projecao.png',
            'imagemSecundaria' => 'preletor.png',
            'imagemAlt' => 'Telão exibindo um versículo bíblico, com o painel do preletor sobreposto',
        ],
        'agenda' => [
            'title' => 'Agenda',
            'icon' => 'bi-calendar3',
