 ...
 * /apps/igrejas sem alterar a estrutura de pastas do site institucional.
 */
final class Router
{
    ...
    public function dispatch(): void
    {
        ...
        // Remove o prefixo de base (ex.: /apps/igrejas) para comparar com
        // os padroes de rota, que sao sempre definidos de forma relativa.
    ...
    private function notFound(): void
    {
        ...
        $viewsPath = dirname(__DIR__, 2) . '/resources/views/errors/404-standalone.php';
