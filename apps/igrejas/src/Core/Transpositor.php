...
final class Transpositor
{
     ...
     * ou bemol), seguida de qualquer combinacao de qualidade/extensao
     * (m, 7, 9, dim, sus4, add9, 7M etc.), extensao entre parenteses
     * opcional (ex.: "(4/9)") e baixo opcional depois de uma barra
     * (ex.: "/B", acorde com inversao).
     */
    private const FORMATO_ACORDE = '/^[A-G](#|b)?([a-zA-Z0-9]*)(\([^)]*\))?(\/[A-G](#|b)?)?$/';
