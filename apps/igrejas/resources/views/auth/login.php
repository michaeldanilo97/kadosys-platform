...
<div class="auth-form-card">
    ...
    <?php if ($pedirSoEmail): ?>
        <form method="POST" action="<?= $basePath ?>/login/localizar" novalidate>
            <?= $csrf ?>
            ...
            <button type="submit" class="btn-k btn-k-grad">Continuar <i class="bi bi-arrow-right"></i></button>
        </form>
    <?php else: ?>
