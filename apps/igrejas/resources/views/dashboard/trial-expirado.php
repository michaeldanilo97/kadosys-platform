...
<h1 class="dash-page-title">Seu teste grátis terminou</h1>
...
<div class="placeholder-box placeholder-box-plano">
    ...
    <h2>Os 7 dias de teste grátis acabaram<?= $expirouEm !== null ? ' em ' . $expirouEm->format('d/m/Y') : '' ?></h2>
    <p>
        Seus dados continuam guardados com segurança - assine um plano (cartão ou Pix) pra liberar o acesso de
        novo, sem perder nada do que já foi cadastrado.
    </p>
