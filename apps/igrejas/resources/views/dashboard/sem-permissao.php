...
<p class="dash-page-subtitle">Voce nao tem permissao para acessar este modulo.</p>
...
<div class="placeholder-box placeholder-box-plano">
    ...
    <p>
        Sua conta nao tem permissao para acessar este modulo. Se voce acredita que deveria ter acesso,
        fale com um administrador da igreja para liberar em Permissoes.
    </p>
