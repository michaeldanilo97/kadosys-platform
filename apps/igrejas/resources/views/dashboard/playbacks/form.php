...
<div class="dash-page-head">
    <div>
        ...
        <p class="dash-page-subtitle">
            <?= $isEdit
                ? 'Atualize o titulo e o artista de ' . htmlspecialchars($playback->titulo, ENT_QUOTES, 'UTF-8') . '.'
                : 'Envie um arquivo de audio (MP3, WAV, OGG, M4A ou AAC, ate 25MB).' ?>
        </p>
    </div>
    ...
    <form method="POST" action="<?= $actionUrl ?>" class="crud-form" enctype="multipart/form-data">
        ...
        <div class="crud-form-section">
            ...
            <div class="crud-form-grid">
                ...
                <div class="crud-field crud-field-full">
                    <label for="artista">Artista / interprete</label>
                    <input type="text" id="artista" name="artista" value="<?= htmlspecialchars($artista, ENT_QUOTES, 'UTF-8') ?>" placeholder="Ex.: Ministerio Morada (opcional)">
                </div>

                <?php if (!$isEdit): ?>
                    <div class="crud-field crud-field-full">
                        <label for="audio">Arquivo de audio *</label>
        ...
        <div class="crud-form-actions">
            ...
            <button type="submit" class="btn-k btn-k-grad">
                <i class="bi bi-check-lg"></i> <?= $isEdit ? 'Salvar alteracoes' : 'Enviar playback' ?>
            </button>
        </div>
    </form>
</div>
