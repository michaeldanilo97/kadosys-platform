    ...
    <div>
        ...
        <p class="dash-page-subtitle">
            <?= $isEdit
                ...
                : 'Preencha os dados para cadastrar um novo bem, imóvel ou equipamento.' ?>
        </p>
    </div>
    ...
    <form method="POST" action="<?= $actionUrl ?>" class="crud-form">
        ...
        <div class="crud-form-section">
            ...
            <div class="crud-form-grid">
                ...
                <div class="crud-field crud-field-full">
                    ...
                    <textarea id="observacoes" name="observacoes" rows="2" placeholder="Histórico de manutenção, garantia, etc. (opcional)"><?= htmlspecialchars($observacoes, ENT_QUOTES, 'UTF-8') ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="crud-form-actions">
            ...
            <button type="submit" class="btn-k btn-k-grad">
                <i class="bi bi-check-lg"></i> <?= $isEdit ? 'Salvar alterações' : 'Cadastrar bem' ?>
            </button>
        </div>
    </form>
</div>
