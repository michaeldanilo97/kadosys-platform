...
/*
|--------------------------------------------------------------------------
| Configuracao geral - KADOSYS Igrejas
|--------------------------------------------------------------------------
|
...
| em https://kadosys.com.br/apps/igrejas quanto em outros caminhos, sem
...
// para obter o caminho base da aplicacao (ex: /apps/igrejas).
$basePath = preg_replace('#/public$#', '', $scriptDir);
$basePath = $basePath === '/' ? '' : rtrim((string) $basePath, '/');

return [
    'app_name'    => 'KADOSYS Igrejas',
    'env'         => getenv('APP_ENV') ?: 'production',
    'debug'       => filter_var(getenv('APP_DEBUG') ?: 'false', FILTER_VALIDATE_BOOLEAN),
    'base_path'   => $basePath,
    'timezone'    => 'America/Sao_Paulo',
    'session_name' => 'kadosys_igrejas_session',
    'remember_cookie' => 'kadosys_igrejas_remember',
